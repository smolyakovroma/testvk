package com.testvk.romansmolakov.testvk.common.manager;
...
public class MyFragmentManager {
    ...
    public void setFragment(BaseActivity activity, BaseFragment fragment, @IdRes int containerId){
         if(activity != null && !activity.isFinishing() && !isAlreadyConstains(fragment)){
    ...
    public boolean isAlreadyConstains(BaseFragment baseFragment){
